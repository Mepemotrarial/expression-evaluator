...
final class Functions {
    ...
    Functions(Locale locale) {
        ...
        this.lastRandomNumber = random.nextInt();
    }
    ...
    double Rnd(int type) {
        ...
        return lastRandomNumber = random.nextDouble();
    }
    ...
    private int getInt(Object value) throws ParseException {
        ...
        throw new IllegalArgumentException("The specified argument cannot be represented as a number.");
    }
